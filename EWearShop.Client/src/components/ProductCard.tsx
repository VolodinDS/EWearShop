        ...
        >
            ...
            <div className="group flex flex-col w-full animate-fade-in">
                <div className="relative aspect-square overflow-hidden bg-[#F2F2F2]">
                    <div className="absolute top-2 left-2 z-10 bg-white/95 px-2 h-5 flex items-center justify-center shadow-sm rounded-2xl">
                    ...
                    <button
                        ...
                        className="absolute bottom-0 left-0 right-0 bg-white/60 backdrop-blur-md py-4 text-[10px] uppercase tracking-[0.2em] opacity-0 translate-y-4 transition-all duration-500 group-hover:opacity-100 group-hover:translate-y-0 active:bg-black active:text-white"
                    >
                        Add to cart
                    </button>
                </div>
